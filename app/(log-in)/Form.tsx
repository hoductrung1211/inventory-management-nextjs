    ...
    return (
        ...
        >
            <section className="mb-4">
                ...
                <h2 className="text-xl font-extrabold text-center text-slate-700">{title}</h2>
            </section>
...
export function Button({
    ...
    return (
        <button className="absolute left-0 right-0 bottom-0 h-10 rounded-md bg-slate-700 text-gray-50 font-bold">
            {text}
        </button>
    )
}