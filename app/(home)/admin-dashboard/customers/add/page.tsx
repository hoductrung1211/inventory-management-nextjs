...
export default function Page() {
    ...
    const requestCreateCustomer = async () => {
        const checked = checkConstraint();
        if (!checked) {
            notify("Create a customer information failed", "error");
            return;
        }
        try {
            showLoading();
            ...
            router.push("./");
            notify("Create a customer information successfully", "success");
        }
        catch (error) {
            console.log(error);
            notify("Create a customer information failed", "error");
            ...
            <Header>
                <div className="flex gap-4">
                    ...
                    <Button 
                        ...
                        color={Color.WHITE}
                        bgColor={Color.GREEN} 
                        actionHandler={requestCreateCustomer}
                    />
                </div>
            </Header>
            <Main>
